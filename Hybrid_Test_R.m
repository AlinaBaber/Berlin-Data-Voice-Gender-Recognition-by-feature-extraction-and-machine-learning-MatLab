function [Category_Error_Rate,Category_Accuracy_Rate,Emotion_Error_Rate,Emotion_Accuracy_Rate,Categories,Emotions,Category_SampleDistribution,Category_ErrorDistribution,Emotion_SampleDistribution,Emotion_ErrorDistribution]= Hybrid_Test_R()
File1=load('Features3');  File=load('speech');
[row,col]=size(File1.File_hybrid_features); Categories={}; Emotions={};
for i=1:row
[Category,Emotion]=hybrid_classification_Test(File1.File_hybrid_features(i,:));
