function [Category_Error_Rate,Category_Accuracy_Rate,Emotion_Error_Rate,Emotion_Accuracy_Rate,Category,Emotion,Category_SampleDistribution,Category_ErrorDistribution,Emotion_SampleDistribution,Emotion_ErrorDistribution]= KNN_Test()
...
%==================Speech Emotions======================================%
[Emotion,Emotion_score,Emotion_cost] = predict(MFile.KNNStruct_emotions,File.features);
